-- Fix get_accounting_data function to use string comparison for trade_date
-- This allows the index on trade_date to be used instead of doing a full table scan
