-- Fix get_accounting_data_v3 to use eod_ledger_snapshots for opening balances instead of balances_raw
...
BEGIN
  ...
  WITH opening_balances AS (
    -- Use eod_ledger_snapshots instead of balances_raw for opening balances
    SELECT 
      els.investor_code,
  ...
  trade_sums AS (
    ...
    WHERE th.trade_date::date = v_tx_date
  ...
  deposit_sums AS (
    ...
    WHERE dw.transaction_date::date = v_tx_date
