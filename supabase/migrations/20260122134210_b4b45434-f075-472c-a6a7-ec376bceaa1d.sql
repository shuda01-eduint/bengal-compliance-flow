-- Fix ambiguous column references and incorrect column names in get_accounting_data_v3
...
BEGIN
  ...
  opening_balances AS (
    ...
    WHERE br.as_of_date = _opening_date::text
  ...
  period_deposits AS (
    ...
    WHERE dw.transaction_date::date BETWEEN _opening_date AND _tx_date
  ...
  period_trades AS (
    ...
    WHERE th.trade_date::date BETWEEN _opening_date AND _tx_date
