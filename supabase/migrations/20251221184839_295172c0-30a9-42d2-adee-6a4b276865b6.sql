...
BEGIN
  ...
  -- This prevents double-counting trades when the start date has both an EOD snapshot and trades
  ...
  -- Get EOD ledger balances from the determined date (day before start date)
  eod_ledgers AS (
    SELECT 
