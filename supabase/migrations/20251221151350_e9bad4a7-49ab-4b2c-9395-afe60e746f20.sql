-- Update get_accounting_data to use nearest EOD snapshot on or before start date
...
-- Update get_accounting_summary to use nearest EOD snapshot on or before start date
