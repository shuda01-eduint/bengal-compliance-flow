-- Fix run_batch_eod to use correct date format and cumulative EOD snapshots
...
BEGIN
  ...
  SELECT 
    ...
    -- Add today's trades: Sell adds value, Buy subtracts value
  ...
  -- Get today's trades (using YYYYMMDD format)
  LEFT JOIN (
    SELECT client_code,
