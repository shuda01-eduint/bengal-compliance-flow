-- Fix process_staged_trades: correct withdrawal type matching and commission calculation
...
BEGIN
  ...
  -- FIXED: Calculate commission from brokerage rates when file has 0
  -- ============================================================
  ...
  SELECT
    ...
    -- Use file commission if present, else calculate from brokerage rate
    SUM(
      CASE 
  ...
  -- FIXED: Include 'WITHDRAW' in withdrawal detection
  -- ============================================================
