-- Add next-day opening balance propagation to process_staged_trades
-- After calculating closing_balance for today, insert/update tomorrow's eod_investor_balance with opening_ledger_balance
...
BEGIN
  ...
  -- STEP 17: NEW - Propagate closing balances to NEXT day's opening balances
