          ...
          if (stockData.success && stockData.data) {
            ...
            const upsertResponse = await fetch(`${supabaseUrl}/rest/v1/securities`, {
              ...
              body: JSON.stringify({
                ...
                close_price: d.market?.ltp || null,
                open_price: d.market?.open || null,
                high_price: d.market?.high || null,
                low_price: d.market?.low || null,
                volume: d.market?.volume || null,
                market_cap: d.fundamentals?.marketCap || null,
                eps: d.fundamentals?.eps || null,
                audited_pe: d.fundamentals?.pe || null,
                week_52_high: d.fundamentals?.yearHigh || null,
                week_52_low: d.fundamentals?.yearLow || null,
